 ...
 * @module hive-cache/lib/backends/redis
...
var events        = require( 'events' )
  ...
  , exceptions    = require( 'hive-stdlib/exception' )
  , noop          = require( 'hive-stdlib/function' ).noop
  , isNumber      = require( 'hive-stdlib/lang').isNumber
  , typecast      = require( 'hive-stdlib/string' ).typecast
  , Cache         = require( './base' )
  ;

/**
 * Redis redis backend for the Cache interface
 * @alias module:hive-cache/lib/backends/redis
 * @constructor
...
module.exports = new Class({
	...
	 * @method module:hive-cache/lib/backends/redis#add
	...
	 * @method  module:hive-cache/lib/backends/redis#get
	...
	 * @method  module:hive-cache/lib/backends/redis#set
	 * @param {String} key Key to identify a value
	 * @param {String|Number} value The value to set at the key
	 * @param {Number} [timeout=Cache.timeout] a timeout override for a specific operation
	 * @param {Function} callback A callback function to be executed when the operation is finished
	...
	 * @method  module:hive-cache/lib/backends/redis#incr
	...
	/**
	 * Increments the value at a key if it exists. if it does not exits, the value will be set to 1
	 * @method  module:hive-cache/lib/backends/redis#decr
	 * @param {String} key The key to increment if it exists
	 * @param {Function} callback A callback function to be executed when the operation is finished
	 **/
	...
	 * @method  module:hive-cache/lib/backends/redis#push
	 * @param {String} key Key to identify a value
	 * @param {String|Number} value The value to set at the key
	 * @param {Number} [timeout=Cache.timeout] a timeout override for a specific operation
	 * @param {Function} callback A callback function to be executed when the operation is finished
	...
	 * @method  module:hive-cache/lib/backends/redis#pop
	 * @param {String} key Key to identify a value
	 * @param {Function} callback A callback function to be executed when the operation is finished
	 **/
	...
	 * @method  module:hive-cache/lib/backends/redis#has
	...
	 * @method  module:hive-cache/lib/backends/redis#flush
	 * @param {Function} callback A callback function to be executed when the operation is finished
	 **/
	...
	 * @method module:hive-cache/lib/backends/redis#close
 ...
 * @callback module:hive-cache/lib/backends/redis~closeCallback
