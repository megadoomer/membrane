 ...
 * ### Configuration
 * Configuring a memcache connection is done through the {@link module:hive-cache|Cache} module.
 ...
 * @module hive-cache/lib/backends/memcached
...
var events    = require( 'events' )                       // node events module
  ...
  , conf      = require( 'hive-conf' )                   // alice config loader
  , logger    = require( 'hive-log' )                    // alice logger
  , async     = require( 'async' )                        // async npm module
  , memjs     = require( 'memjs' )
  , noop      = require( 'hive-stdlib/function' ).noop   // default empty function
  , Exception = require( 'hive-stdlib/exception' )       // base Exception
  , Class     = require( 'hive-stdlib/class' )           // Class lib from hive-stdlib
  , remove    = require( 'hive-stdlib/array' ).remove    // remove standard remove function
  , compact   = require( 'hive-stdlib/array' ).compact   // compact standard compact function
  , flatten   = require( 'hive-stdlib/array' ).flatten   // flatten standard flatten function
  , toArray   = require( 'hive-stdlib/lang' ).toArray    // toArray standard toArray function
  , isString  = require( 'hive-stdlib/lang' ).isString   // isStringstandard isStringfunction
  , isNull    = require( 'hive-stdlib/lang' ).isNull     // isNull standard isNull function
  , clone     = require( 'hive-stdlib/lang' ).clone      // clone standard clone function
  , merge     = require( 'hive-stdlib/object' ).merge    // merge standard merge function
  , typecast  = require( 'hive-stdlib/string' ).typecast // typecast standard typecast function
  , typeOf    = require( 'hive-stdlib/typeOf' )          // typeOf method from mout
  , url       = require( 'hive-stdlib/url' )
...
/**
 * @extends module:hive-cache/lib/backends/base
 * @constructor
 * @alias module:hive-cache/lib/backends/memcached
...
module.exports = new Class({
	...
	 * @method module:hive-cache/lib/backends/memcached#add
	...
	 * @method module:hive-cache/lib/backends/memcached#get
	...
	 * @method module:hive-cache/lib/backends/memcached#set
	 * @param {String} key Key to identify a value
	 * @param {String|Number} value The value to set at the key
	 * @param {Number} [timeout=Cache.timeout] a timeout override for a specific operation
	 * @param {Function} callback A callback function to be executed when the operation is finished
	...
	 * @method module:hive-cache/lib/backends/memcached#incr
	...
	/**
	 * Increments the value at a key if it exists. if it does not exits, the value will be set to 1
	 * @method module:hive-cache/lib/backends/memcached#decr
	 * @param {String} key The key to increment if it exists
	 * @param {Function} callback A callback function to be executed when the operation is finished
	 **/
	...
	 * @method module:hive-cache/lib/backends/memcached#push
	 * @param {String} key Key to identify a value
	 * @param {String|Number} value The value to set at the key
	 * @param {Number} [timeout=Cache.timeout] a timeout override for a specific operation
	 * @param {Function} callback A callback function to be executed when the operation is finished
	...
	 * @method module:hive-cache/lib/backends/memcached#pop
	 * @param {String} key Key to identify a value
	 * @param {Function} callback A callback function to be executed when the operation is finished
	 **/
	...
	 * @method module:hive-cache/lib/backends/memcached#has
	...
	 * @method module:hive-cache/lib/backends/memcached#flush
	 * @param {Function} callback A callback function to be executed when the operation is finished
	 **/
	...
	 * @method module:hive-cache/lib/backends/memcached#close
 ...
 * @callback module:hive-cache/lib/backends/memcached~closeCallback
