 ...
 * @module hive-cache/lib/backends/dummy
 * @author Eric Satterwhite
 * @since 0.1.0
 * @requires hive-stdlib/class
 * @requires hive-core/exceptions
 * @requires hive-stdlib/function
 * @requires hive-cache/backends/base
 */
var logger = require('hive-log')                    // hive-log package
  , Class  = require( 'hive-stdlib/class' )         // standard class implementation
  , noop   = require( 'hive-stdlib/function' ).noop // empty function
  , Cache  = require( './base' )                     // Base Cache interface to implmement
  ;

/**
 * Dummy Cache backend for testing
 * @alias module:hive-cache/lib/backends/dummy
 * @constructor 
 ...
 */
module.exports = new Class(/* @lends module:hive-cache/lib/backends/dummy.prototype */{
	inherits: Cache
	...
	 * @method module:hive-cache/lib/backends/dummy#add
	...
	 * @method module:hive-cache/lib/backends/dummy#get
	...
	 * @method module:hive-cache/lib/backends/dummy#set
	 * @param {String} key Key to identify a value
	 * @param {String|Number} value The value to set at the key
	 * @param {Number} [timeout=Cache.timeout] a timeout override for a specific operation
	 * @param {Function} callback A callback function to be executed when the operation is finished
	...
	 * @method module:hive-cache/lib/backends/dummy#incr
	...
	/**
	 * Increments the value at a key if it exists. if it does not exits, the value will be set to 1
	 * @method module:hive-cache/lib/backends/dummy#decr
	 * @param {String} key The key to increment if it exists
	 * @param {Function} callback A callback function to be executed when the operation is finished
	 **/
	...
	 * @method module:hive-cache/lib/backends/dummy#push
	 * @param {String} key Key to identify a value
	 * @param {String|Number} value The value to set at the key
	 * @param {Number} [timeout=Cache.timeout] a timeout override for a specific operation
	 * @param {Function} callback A callback function to be executed when the operation is finished
	...
	 * @method module:hive-cache/lib/backends/dummy#pop
	 * @param {String} key Key to identify a value
	 * @param {Function} callback A callback function to be executed when the operation is finished
	 **/
	...
	 * @method module:hive-cache/lib/backends/dummy#has
	...
	 * @method module:hive-cache/lib/backends/dummy#flush
	 * @param {Function} callback A callback function to be executed when the operation is finished
	 **/
	...
	 * @method module:hive-cache/lib/backends/dummy#close
 ...
 * @callback module:hive-cache/lib/backends/dummy~closeCallback
